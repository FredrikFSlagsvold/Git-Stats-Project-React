...
export default function CommitsInfo() {
    ...
    return (
        <div>
            <h1> Commits data</h1>
            <h3 > Commit Title: <ul style={{display: "flex", flexWrap: 'wrap', justifyContent: 'center-around', listStyle: 'none'}}>{commits.map((commit) => { return <li style={{margin: '40px'}}>{commit.title}</li>})}</ul></h3>
